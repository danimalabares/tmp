...
\centering
\includegraphics[width=\linewidth,height=4.2cm,keepaspectratio]{Pierre_Dolbeault.jpg}

\scriptsize Pierre Dolbeault
\end{column}
\end{columns}
...
\centering
\includegraphics[width=\linewidth,height=3.2cm,keepaspectratio]{Stone.jpeg}

\scriptsize Marshall H. Stone
\end{minipage}\hfill
\begin{minipage}[t]{0.48\linewidth}
\centering
\includegraphics[width=\linewidth,height=3.2cm,keepaspectratio]{Karl_Weierstrass.jpg}

\scriptsize Karl Weierstrass
\end{minipage}
\end{column}
\end{columns}
\end{frame}
...
\[
 ...
 &=\frac1{2(2\pi)^2}\int_E(h_x+i h_y)\,dx\,dy\\
 &=0.
 \end{aligned}
\]
...
\begin{column}{0.22\textwidth}
\centering
\includegraphics[width=\linewidth,height=4.2cm,keepaspectratio]{De_Rham.jpeg}

\scriptsize Georges de Rham
\end{column}
\end{columns}
\end{frame}
