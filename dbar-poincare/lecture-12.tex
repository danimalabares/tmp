...
Stone--Weierstrass.
\src{Verbitsky, Lecture 12, pp. 2--4; \texttt{functional-analysis} notes, Stone--Weierstrass theorem.}
\end{frame}
...
\end{itemize}
Therefore the complex Stone--Weierstrass theorem gives
\[
 \overline A^{\,\|\cdot\|_\infty}=C(S^1,\C).
\]

Thus every continuous function can be approximated uniformly by Fourier
polynomials.
\end{frame}
