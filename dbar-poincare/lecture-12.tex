...
\begin{frame}{Proof of the eigenvalue formula}
Let
\[
 \eta_{n,m}=\ee\alpha,\qquad
 \ee=e^{inx+imy},\qquad X=\partial_x,
\]
...
\]
Translation invariance gives $\Lie_X\alpha=0$, while
\[
 X(\ee)=\partial_x e^{inx+imy}=in\,\ee.
\]
Therefore
\[
 \Lie_X\eta_{n,m}=in\,\ee\alpha=in\,\eta_{n,m}.
\]
Each Fourier mode is an eigenvector of $\Lie_X$ with eigenvalue $in$.
\end{frame}
